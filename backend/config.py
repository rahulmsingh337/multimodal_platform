...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.environ.get(
        "DATABASE_URL", "postgresql+asyncpg://user:password@localhost/multimodal_db"
    )
    DATABASE_SYNC_URL: str = os.environ.get(
        "DATABASE_URL", "postgresql://user:password@localhost/multimodal_db"
    )
    ...
    CLOUDFRONT_DOMAIN: str = os.environ.get(
