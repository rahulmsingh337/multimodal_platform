    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-white/40 mt-1">
          Multimodal AI generation platform — overview
        </p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div key={label} className="glass rounded-xl p-5">
            ...
            {delta && (
              <div className="text-[11px] text-indigo-400 mt-2">{delta}</div>
            )}
          </div>
        ))}
      </div>
                ...
                <div className="relative flex h-2 w-2 flex-shrink-0">
                  ...
                  <span
                    className={clsx(
                      ...
                      e.status === "online" ? "bg-emerald-500" : "bg-white/20",
                    )}
                  />
                </div>
              </div>
        ...
        {[
          {
            href: "/avatar/create",
            label: "Create Avatar",
            desc: "Upload image · train LoRA",
            icon: "👤",
            grad: "from-violet-500/20 to-purple-600/10",
          },
          {
            href: "/generate",
            label: "Generate Video",
            desc: "Text → animated avatar → CDN",
            icon: "🎬",
          ...
          },
          {
            ...
            desc: "ElevenLabs TTS · clone voice",
            icon: "🎙️",
            grad: "from-pink-500/20 to-rose-600/10",
          },
          ...
          <Link
            ...
            href={href}
            className={clsx(
              "glass rounded-xl p-5 bg-gradient-to-br hover:scale-[1.02] transition-transform duration-150",
              grad,
            )}
          >
