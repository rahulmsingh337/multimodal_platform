      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 border-r border-white/[0.06] bg-gradient-to-br from-indigo-950/40 to-purple-950/20">
        ...
        <div>
          ...
          <p className="text-white/40 text-sm leading-relaxed max-w-sm">
            Full-stack multimodal generation platform. GPT-4o NLP, SDXL images,
            SadTalker animation, SVD video, and ElevenLabs voice — all in one
            pipeline.
          </p>
            ...
            {[
              {
                icon: Users,
                label: "Avatar Studio",
                desc: "Upload, train LoRA, animate with voice",
              },
              {
                icon: Video,
                label: "Text → Video",
                desc: "Full SVD pipeline with NLP refinement",
              },
              {
                icon: Zap,
                label: "Voice Synthesis",
                desc: "ElevenLabs TTS with voice cloning",
              },
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-white/40 text-sm mb-8">
            Authentication required to access the platform
          </p>
          ...
          <div className="mt-6 p-4 rounded-xl bg-amber-500/5 border border-amber-500/15">
            <p className="text-xs text-amber-400/80 leading-relaxed">
              ...
              to Vercel environment variables to enable Google sign-in.
            </p>
          </div>
        </div>
      </div>
